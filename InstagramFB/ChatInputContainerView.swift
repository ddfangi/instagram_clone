...
class ChatInputContainerView: UIView, UITextFieldDelegate {
    ...
    override init(frame: CGRect) {
        ...
        uploadImageView.anchor(top: nil, leading: leadingAnchor, bottom: nil, trailing: nil, paddingTop: 0, paddingLeft: 4, paddingBottom: 0, paddingRight: 0, width: 34, height: 30)
        uploadImageView.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        
        sendButton.anchor(top: nil, leading: nil, bottom: nil, trailing: trailingAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 80, height: self.frame.height)
        sendButton.anchorCenterYToSuperview()
        
        inputTextField.anchor(top: topAnchor, leading: uploadImageView.trailingAnchor, bottom: bottomAnchor, trailing: sendButton.leadingAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
        
        seperatorLineView.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0.7)
